...
export class SearchCopyByCodeUseCase {
  private readonly loggerContext = "SearchCopyByCodeUseCaseExecute";
  ...
  async execute(code: string): Promise<BookCopySummaryWithBook> {
